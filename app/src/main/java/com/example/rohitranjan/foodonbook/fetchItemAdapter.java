...
public class fetchItemAdapter extends ArrayAdapter {
    private Activity context;
    private int resource;
    private List<pojoFetchItem> listImage;

    public fetchItemAdapter(@NonNull Activity context, int resource, @NonNull List<pojoFetchItem> objects) {
